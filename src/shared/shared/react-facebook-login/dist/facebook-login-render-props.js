!(function(e, t) {
  "object" == typeof exports && "object" == typeof module
    ...
    ? (exports.FacebookLogin = t(require("react")))
    : (e.FacebookLogin = t(e.react));
})(this, function(e) {
  return (function(e) {
    function t(n) {
      ...
      var a =
        ...
        k = (function(e) {
          function t() {
            ...
            return (
              (o = n = i(this, (e = t.__proto__ || Object.getPrototypeOf(t)).call.apply(e, [this].concat(u)))),
              (n.state = { isSdkLoaded: !1, isProcessing: !1 }),
              ...
              (n.checkLoginState = function(e) {
                n.setStateIfMounted({ isProcessing: !1 }),
                  e.authResponse
                    ? n.responseApi(e.authResponse)
                    : n.props.onFailure
                    ? n.props.onFailure({ status: e.status })
                    : n.props.callback({ status: e.status });
              }),
              ...
              (n.click = function(e) {
                if (n.state.isSdkLoaded && !n.state.isProcessing && !n.props.isDisabled) {
                  ...
                  if ("function" != typeof i || (i(e), !e.defaultPrevented)) {
                    ...
                    if (n.props.isMobile && !u)
                      window.location.href = "https://www.facebook.com/dialog/oauth" + (0, b["default"])(p);
                    else {
                      if (!window.FB)
                        return void (n.props.onFailure && n.props.onFailure({ status: "facebookNotLoaded" }));
                      window.FB.login(n.checkLoginState, { scope: o, return_scopes: s, auth_type: p.auth_type });
                    }
                  }
                }
              }),
              ...
              },
              {
                ...
                value: function() {
                  ...
                  window.fbAsyncInit = function() {
                    window.FB.init({ version: "v" + i, appId: o, xfbml: n, status: true, cookie: r }),
                ...
                value: function() {
                  ...
                  !(function(t, o, n) {
                    ...
                    t.getElementById(n) ||
                      ((s = t.createElement(o)),
                      (s.id = n),
                      (s.src = "https://connect.facebook.net/" + e + "/sdk.js"),
