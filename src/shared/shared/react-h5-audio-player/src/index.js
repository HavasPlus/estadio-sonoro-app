...
class H5AudioPlayer extends Component {
  ...
  render() {
    ...
    const incompatibilityMessage = children || (
      <p>
        Seu navegador nāo suporta o <code>audio</code> elemento.
      </p>
    );
          ...
          <div className="progress-bar-wrapper" style={style.progressBarWrapper}>
            <div className="audio-info" style={style.audioInfo}>
              <div className="time" style={style.time}>
                <span style={{ color: "#a7a7a7" }} className="current-time">
            ...
            <div
              style={{ justifyContent: this.props.deleteIcon ? "space-between" : "center", margin: "24px 0", zIndex: 2, display: "flex", flex: "1" }}
            >
              ...
              <span
                ...
                role="button"
              >
                <img src={this.props.playIcon} style={{ height: 28 }} alt="Reproduzir e pausar" />
              </span>
              <span
                onClick={() => {
                  this.props.onAbort();
                ...
                role="button"
              >
                {this.props.deleteIcon && <img src={this.props.deleteIcon} style={{ height: 28 }} alt="Deletar" />}
              </span>
            </div>
          </div>
        </div>
