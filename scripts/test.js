...
// Checks if test is in git, then only runs tests that are in changed files.
...
// Checks if test is in Mercurial repo, then only runs tests that are in changed files.
